...
func keyTest(sharpsFlats int8, mode KeySignatureMode, expectedDegree ScaleDegree, expectedMode KeySignatureMode, message string, t *testing.T) {
	gotKey, gotMode := keySignatureFromSharpsOrFlats(sharpsFlats, uint8(mode))
